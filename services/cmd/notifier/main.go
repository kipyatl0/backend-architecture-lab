...
func (a *app) callProvider(cfg config) error {
...
func main() {
	...
	a := &app{cfg: config{Mode: "ok", DelayMS: 0, Strict: true, ProviderMode: "ok", ProviderRetries: 0}}
	...
	mux.HandleFunc("POST /notifications", func(w http.ResponseWriter, r *http.Request) {
		...
		if err := a.callProvider(cfg); err != nil {
			a.rejected.Add(1)
